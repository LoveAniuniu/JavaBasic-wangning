...
public class HttpRequest {
    ...
    //get请求，link是url，dataMap是参数值，headMap是头信息
    ...
    public static JSONObject getReturnJSON(String result, int Httpcode,Map<String,String> headers,Map<String,String> cookies,long beginTime,long endTime) throws JSONException {
        ...
        try {
            JS.put("httpcode", Httpcode);//返回的状态码
            JS.put("header",new JSONObject(headers));//头信息
    ...
    public static void main(String[] args) throws Exception {
        String url = "http://172.28.34.22:8080/loancore/user/home";
        Map<String,String> heapMap = new HashMap<String,String>();
        JSONObject json = get(url,null,heapMap);
